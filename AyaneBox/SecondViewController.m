...
- (id)init
{
    self = [super init];
    if (self) {
        NSString *filepath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"simple-drum-beat.wav"];
...
static void AudioPlayerAQInputCallback(void *input, AudioQueueRef outQ, AudioQueueBufferRef outQB)
{
    ...
    SecondViewController *mainviewcontroller = (__bridge SecondViewController *)input;
