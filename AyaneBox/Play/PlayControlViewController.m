...
//    初始化3D图
    ...
    self.fftSamplesDelegate = self.spectogramSurfaceController.updateDataSeries;
...
- (void)playAudioTimer{
    ...
    if (wavLength > 0) {
        ...
        //            绘制图形
        NSData *sampleData = [NSData dataWithData:data];
        ...
        Byte* samples = (Byte *)[sampleData bytes];
        BOOL isLE = YES;
        ...
        for (int k4 = 0; k4 < audioPlayLength; k4 = k4 + 2) {
            if (k4 % 2 == 0) {
                ...
                if (isLE) {
                    ...
                    v04[k4 / 2] = (int) ((samples[k4] & 0xff) | samples[k4 + 1] << 8);
...
//
        ...
        //            [self.audioWaveformSurfaceView updateDataSeries:sampleData];
        ...
        //            [self.playWavFileData resetBytesInRange:NSMakeRange(0, self.playWavFileData.length)];
