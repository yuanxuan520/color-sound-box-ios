...
- (void)createDownloadDirName:(NSString *)dirName{
    ...
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSString *testDirectory = [[documentsPath stringByAppendingPathComponent:KLCDATA] stringByAppendingPathComponent:dirName];
    // 创建目录
    if ([fileManager fileExistsAtPath:testDirectory]) {
        NSLog(@"已存在此文件夹");
    }else{
...
- (BOOL)deleteFile:(NSString *)filename{
    NSString *documentsPath =[self dirDoc];
    NSString *dirName = [NSString stringWithFormat:@"%@%@",[[NSUserDefaults standardUserDefaults] objectForKey:@"userId"],KLCDATA];
    NSString *testDirectory = [[documentsPath stringByAppendingPathComponent:KLCDATA] stringByAppendingPathComponent:dirName];
    NSString *filePath = [testDirectory stringByAppendingPathComponent:filename];
    NSFileManager *fileManager = [NSFileManager defaultManager];
